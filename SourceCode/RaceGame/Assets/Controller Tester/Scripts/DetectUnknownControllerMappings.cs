...
public class DetectUnknownControllerMappings : MonoBehaviour {
	...
	void Update () {
        ...
        if (Input.GetAxis("Trigger1") > 0f)
            axis3Value.text = "positive";
        else if (Input.GetAxis("Trigger1") < 0f)
            axis3Value.text = "negative";
        else
            axis3Value.text = "";

        if (Input.GetAxis("Trigger2") > 0f)
            axis4Value.text = "positive";
        else if (Input.GetAxis("Trigger2") < 0f)
        ...
        //buttons
        if (Input.GetAxis("AButton1") == 1)
            button0Value.text = "pressed";
        else
            button0Value.text = "";

        if (Input.GetAxis("AButton2") == 1)
